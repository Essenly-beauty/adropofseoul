...
import { skinTypeLabel, concernLabel, functionLabel } from "@/lib/beauty";
...
export async function generateMetadata({
  ...
  const description = ing.metaDescription ?? ing.summary ?? undefined;
  return {
    ...
    openGraph: {
      ...
      description,
      type: "article",
      url: canonical(`/ingredients/${ing.slug}`),
    },
  };
}
    ...
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <section className="mt-12 border-y border-soft-gray py-8">
        ...
        <p className="mt-3 max-w-2xl text-text-muted">
          ...
          actives, your routine, and product guides before you buy anything.
        </p>
