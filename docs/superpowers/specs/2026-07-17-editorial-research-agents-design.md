...
| **Track 2 — Research + Gate 1** ✅ done (2026-07-17, + image candidates, booking hints) | `services/agents/research.ts` (Reddit + web + extract + dedupe + persist); admin `candidates/` review surface + approve/reject/promote actions; manual trigger; one Vercel Cron                                               | Track 1            |
| **Track 3 — Writing + AI review** ✅ writer done (2026-07-17); AI-review panel pending  | `services/agents/writer.ts` (area+places → guide draft with NOTE slots/links/FAQ/SEO); `review.ts` + edit-page AI-review panel; manual trigger                                                                                | Track 2, Admin CMS |
